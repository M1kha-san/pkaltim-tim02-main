<?php
/**
 * Admin Destinasi Create - Form Tambah Destinasi Baru
 */
...
<div class="main-content">
    ...
    <header class="bg-white border-b border-gray-100 px-6 py-4">
        <div class="flex items-center justify-between">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h1 class="text-2xl font-bold text-gray-800">Tambah Destinasi</h1>
                    <p class="text-gray-500 text-sm mt-1">Isi form untuk menambahkan destinasi baru</p>
                </div>
            </div>
        </div>
    </header>
    ...
    <main class="p-6">
        ...
        <form action="<?= BASE_URL ?>admin/destinasi/store" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="bg-white rounded-xl border border-gray-100 p-6">
                        ...
                        <div class="space-y-5">
                            <div>
                                ...
                                <input type="text" name="nama" class="form-input" placeholder="Contoh: Pantai Manggar Segara Sari" required>
                            </div>
                            ...
                            <div>
                                ...
                                <textarea name="deskripsi" rows="4" class="form-input" placeholder="Jelaskan tentang destinasi wisata ini..." required></textarea>
                            </div>
                            
                            <div>
                                <label class="form-label">Sejarah (Opsional)</label>
                                <textarea name="sejarah" rows="3" class="form-input" placeholder="Ceritakan sejarah atau latar belakang tempat ini..."></textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-xl border border-gray-100 p-6">
                        ...
                        <div class="space-y-5">
                            <div>
                                ...
                                <input type="text" name="alamat" class="form-input" placeholder="Jl. Contoh No. 123, Kecamatan, Kota">
                            </div>
                            
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                                <div>
                                    <label class="form-label">Latitude</label>
                                    <input type="text" name="latitude" class="form-input" placeholder="-1.2345678">
                                </div>
                                <div>
                                    <label class="form-label">Longitude</label>
                                    <input type="text" name="longitude" class="form-input" placeholder="116.8765432">
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                                <div>
                                    ...
                                    <input type="text" name="harga_tiket" class="form-input" placeholder="Rp 10.000 - Rp 50.000">
                                </div>
                                <div>
                                    <label class="form-label">Jam Operasional</label>
                                    <input type="text" name="jam_operasional" class="form-input" placeholder="08:00 - 17:00 WITA">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-xl border border-gray-100 p-6">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <input type="number" name="rating" step="0.1" min="0" max="5" value="0" class="form-input">
                            </div>
                            
                            <div class="flex items-center gap-3 py-3 border-t border-gray-100">
                                <input type="checkbox" name="is_featured" id="is_featured" value="1" class="w-5 h-5 rounded border-gray-300 text-[#1D546D] focus:ring-[#5F9598]">
